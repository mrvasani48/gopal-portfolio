  ...
  testimonial_content: [
    {
      ...
      rating: 5,
      feedback:
        "Kishan has consistently delivered high-quality full-stack applications, demonstrating expertise in React, Node.js, and MongoDB. His leadership and commitment have been key to our projects’ success.",
    },
    {
      image: images.profile1,
      name: "Anonymous User",
...
export const PORTFOLIO_DATA = {
  ...
  portfolio_content: [
    ...
    },
    {
      ...
      altText: "C: Back In Stock ‑ Pre Orders",
      title: "Back In Stock ‑ Pre Orders",
      category: "Shopify",
      likes: 850,
      description:
